	...
	while (true)
	{
		...
		else
		{
			...
			if (m_bSleep == false && m_bRunGameLoop == true)
			{
				...
				//Limit tickTimeNow to prevent physics explosion after breakpoint or at first tick
				if(tickTimeNow>0.05)tickTimeNow=0.05;
...
POINT GameEngine::GetMousePosition()
{
